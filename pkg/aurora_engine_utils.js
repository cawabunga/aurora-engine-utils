...
*/
module.exports.parseTransaction = function(bytes, block_height) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.parseTransaction(retptr, ptr0, len0, !isLikeNone(block_height), isLikeNone(block_height) ? BigInt(0) : block_height);
...
const path = require('path').join(__dirname, 'aurora_engine_utils_bg.wasm');
